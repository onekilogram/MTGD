...
public class TypeUtils {
	...
	public static class SimpleDate implements Comparable<SimpleDate> {
		...
		public static int[] daysPerMonth = new int[] { 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30,
				31 };
		...
		public int compareTo(SimpleDate d) {
			if (d.getYear() < year || (d.getYear() == year && d.getMonth() < month)
					|| (d.getYear() == year && d.getMonth() == month && d.getDay() < day))
				return 1;
