...
public class Distributions {
	...
	public static synchronized Distributions getDefaultDistributions() {
		if (DEFAULT_DISTRIBUTIONS == null) {
			try {
				// URL resource = Resources.getResource(Distribution.class,
				// "dists.dss");
				...
				DEFAULT_DISTRIBUTIONS = new Distributions(DistributionLoader
	...
	private static Distribution getDistribution(Map<String, Distribution> distributions,
			String name) {
