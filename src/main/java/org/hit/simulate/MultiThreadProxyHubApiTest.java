...
//import org.tfelab.conn.ConnectionManager;  
            ...
            Runnable run = new Runnable() {  
                ...
                public void run() {  
                    ...
                    try {  
                    	...
                    	URL realUrl = new URL(currentObj.url+currentObj.postData);
                        // 打开和URL之间的连接
...
//                        BufferedReader reader = new BufferedReader(new InputStreamReader(urlconn.getInputStream(),"UTF-8"));  
    ...
    public static void main(String[] args) {  
        //总访问量和并发量两重循环，依次增大访问  
        for(int j=5000; j<5050; j+= 100){  
            for(int i=10; i<10000; i+=10){  
                //要测试的URL  
                String url="http://192.168.1.50:9090/monitor/";  
